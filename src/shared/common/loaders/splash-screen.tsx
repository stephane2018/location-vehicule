    ...
    <div>
      ...
      >
        <div className="flex w-full flex-col items-center justify-center gap-6 px-8">
          ...
          <div className="w-56 h-16 bg-muted rounded-lg flex items-center justify-center text-muted-foreground">
            Logo
          </div>

          <div className="relative h-2.5 w-full overflow-hidden rounded-lg bg-accent md:max-w-xl xl:max-w-md">
            <div className="duration-1500 absolute inset-0 h-full w-full animate-splash-progress rounded-lg bg-primary" />
          </div>
        </div>
      </motion.div>
    </div>
