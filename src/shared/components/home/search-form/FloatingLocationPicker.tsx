...
export function FloatingLocationPicker({
  onSelect,
  onClose,
}: FloatingLocationPickerProps) {
  const [search, setSearch] = useState("");
  const [activeAgence, setActiveAgence] = useState<Agence | null>(
    AGENCES_MOCK[0]
  );

  const handleSelect = (agence: Agence) => {
    onSelect(agence);
    onClose();
  };
              ...
              <div className="p-4 flex-1 space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-xs text-muted-foreground">
                      {activeAgence.vehiculesDisponibles} vehicules disponibles
                      sur {activeAgence.nombreVehicules}
                    </span>
                  </div>
                </div>
